...
// Verifica si se pasó el ID de la venta
...
// Consultar los detalles de la venta y unir con la tabla productos
$sqlDetalles = "SELECT dv.id_detalle, dv.codigo_producto, dv.cantidad_vendida, dv.precio_unitario, 
                       p.nombre AS producto_nombre, p.descripcion, p.marca, p.categoria
...
<body>
    <div class="container mt-5">
        ...
        <?php else: ?>
            <p class="alert alert-info">No hay productos registrados en esta venta.</p>
        <?php endif; ?>
    </div>
